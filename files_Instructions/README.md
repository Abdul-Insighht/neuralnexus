...
```bash
# Launch the Intelligence Portal
...
> 📥 [financial_data_template.csv](https://raw.githubusercontent.com/YOUR_USERNAME/neuralnexus/main/sample_data/financial_data_template.csv)
...
> 📥 [enterprise_report_template.xlsx](https://raw.githubusercontent.com/YOUR_USERNAME/neuralnexus/main/sample_data/enterprise_report_template.xlsx)
...
**Download sample PDF:**
> 📥 [sample_audit_report.pdf](https://raw.githubusercontent.com/YOUR_USERNAME/neuralnexus/main/sample_data/sample_audit_report.pdf)
...
| OpenCorporates Data | CSV | [opencorporates.com/data](https://opencorporates.com/data) | Company entity reconciliation |
| Federal Reserve Economic Data | CSV | [fred.stlouisfed.org](https://fred.stlouisfed.org) | Macroeconomic anomaly detection |
...
**Quick test with Kaggle Superstore:**
1. Download `Sample - Superstore.csv` from Kaggle
2. Split into 2 CSVs: one for East region, one for West
3. Manually change 2–3 revenue figures in one file
4. Upload both into NeuralNexus
5. Watch contradictions get auto-detected
...
├── app/
│   ├── main.py                     # Streamlit Intelligence Portal (entry point)
...
| Frontend | Streamlit + Plotly | Rapid demo-ready UI with interactive charts |
...
Live URL is shareable instantly — perfect for judge evaluation.
